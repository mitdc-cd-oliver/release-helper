...
export default function TimeTravelPanel({ enabled, onNowChange }: TimeTravelPanelProps) {
  ...
  return (
    <div className="fixed right-6 top-6 z-10 text-xs text-slate-200">
      <button
      ...
      {showPanel && (
        <div className="mt-3 w-72 rounded-xl border border-slate-800 bg-slate-950/90 p-4 shadow-lg backdrop-blur">
